...
import { idlFactory } from './terrax.did.js';
export { idlFactory } from './terrax.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TERRAX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./terrax.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the terrax canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./terrax.did.js")._SERVICE>}
 */
export const terrax = createActor(canisterId);
